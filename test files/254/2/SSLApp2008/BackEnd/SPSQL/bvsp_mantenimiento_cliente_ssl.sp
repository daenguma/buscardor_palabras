...
go
/************************************************************************/
/*  ARCHIVO:         bvsp_mantenimiento_cliente_ssl.sp	                */
/*  NOMBRE LOGICO:   bvsp_mantenimiento_cliente_ssl.sp		            */
...
/************************************************************************/
alter procedure bvsp_mantenimiento_cliente_ssl(
			@s_ssn                int, 
			@s_user               login, 
			@s_sesn               int = null, 
			@s_term               varchar(30), 
...
IF OBJECT_ID('dbo.bvsp_mantenimiento_cliente_ssl') IS NOT NULL
    PRINT '<<< ALTERED PROCEDURE dbo.bvsp_mantenimiento_cliente_ssl>>>'
ELSE
    PRINT '<<< FAILED ALTERING PROCEDURE dbo.bvsp_mantenimiento_cliente_ssl>>>'
go
