...
/************************************************************************/
/*  ARCHIVO:         sp_login_web.sp	                				*/
/*  NOMBRE LOGICO:   sp_login_web.sp		            				*/
...
IF OBJECT_ID('dbo.sp_login_web') IS NOT NULL
    PRINT '<<< ALTERED PROCEDURE dbo.sp_login_web>>>'
ELSE
    PRINT '<<< FAILED ALTERING PROCEDURE dbo.sp_login_web>>>'
go
