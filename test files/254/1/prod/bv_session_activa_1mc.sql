USE webuser_bit
go
REVOKE EXECUTE ON dbo.bv_session_activa_1mc FROM [roleBancaMovil ]
go
IF OBJECT_ID('dbo.bv_session_activa_1mc') IS NOT NULL
BEGIN
    DROP PROCEDURE dbo.bv_session_activa_1mc
    IF OBJECT_ID('dbo.bv_session_activa_1mc') IS NOT NULL
        PRINT '<<< FAILED DROPPING PROCEDURE dbo.bv_session_activa_1mc >>>'
    ELSE
        PRINT '<<< DROPPED PROCEDURE dbo.bv_session_activa_1mc >>>'
END
go
SET ANSI_NULLS ON
go
...
CREATE Procedure bv_session_activa_1mc
( 
...
go
IF OBJECT_ID('dbo.bv_session_activa_1mc') IS NOT NULL
    PRINT '<<< CREATED PROCEDURE dbo.bv_session_activa_1mc >>>'
ELSE
    PRINT '<<< FAILED CREATING PROCEDURE dbo.bv_session_activa_1mc >>>'
go
GRANT EXECUTE ON dbo.bv_session_activa_1mc TO [roleBancaMovil ]
go
