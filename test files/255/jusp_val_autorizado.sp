...
ALTER Procedure jusp_val_autorizado(  
@s_ssn               int          = null,  
@s_user              varchar(20),  
@s_term              varchar(30),  
@s_date              datetime,  
...
IF OBJECT_ID('jusp_val_autorizado') IS NOT NULL
    PRINT '<<< ALTER PROCEDURE jusp_val_autorizado>>>'
ELSE
    PRINT '<<< FAILED ALTERING PROCEDURE jusp_val_autorizado>>>'
go
