...
/*  Julio/2020  Maria Colina       	Crear cliente desde cero  */
/*                                  en la bv_ente_servicio    */
/*	27-07-2021	Adolfo Hernández	Migración ATMSRV		  */
/**************************************************************/

USE webuser_jur
GO

ALTER Procedure [dbo].[jusp_oper_autorizado_cm](
  @s_ssn               int          = null,
  @s_user              varchar(20),
  @s_term              varchar(30),
  @s_date              datetime,
...
IF OBJECT_ID('jusp_oper_autorizado_cm') IS NOT NULL
    PRINT '<<< ALTER PROCEDURE jusp_oper_autorizado_cm>>>'
ELSE
    PRINT '<<< FAILED ALTERING PROCEDURE jusp_oper_autorizado_cm>>>'
go