/******************************************************************/ 
/*    NOMBRE ARCHIVO:  jusp_op_solicitudes.sp                     */  
...
ALTER PROCEDURE  jusp_op_solicitudes  (  
...
begin  
  ...
  select @w_sqlsol = @w_sqlsol + 'case a.js_estado when ' + char(39) + 'C' + char(39) + ' then ' + char(39) + 'RECHAZADA' + char(39) + ' when ' + char(39) + 'A' + char(39) + ' then ' + char(39) + 'APROBADA' + char(39) + ' when ' + char(39) + 'R' + char(39
  ...
  begin  
    select @w_sqlsol = @w_sqlsol + ' and (a.js_fecha_aprob >= ' + char(39) + convert(varchar,@i_fecha_desde,101) + char(39) + ' or a.js_fecha_rev >= ' + char(39) + convert(varchar,@i_fecha_desde,101) + char(39) + ' or a.js_fecha_recha >= ' + char(39) + convert(varchar,@i_fecha_desde,101) + char(39) + ')'  
  end  
    
  if isnull(@i_fecha_hasta,'01/01/2000') != '01/01/2000'  
  begin  
    select @w_sqlsol = @w_sqlsol + ' and (a.js_fecha_aprob <= ' + char(39) + convert(varchar,@i_fecha_hasta,101) + char(39) + ' or a.js_fecha_rev <= ' + char(39) + convert(varchar,@i_fecha_hasta,101) + char(39) + ' or a.js_fecha_recha <= ' + char(39) + convert(varchar,@i_fecha_hasta,101) + char(39) + ')'  
  end  
...
IF OBJECT_ID('jusp_op_solicitudes') IS NOT NULL
begin
    PRINT '<<< ALTER PROCEDURE jusp_op_solicitudes>>>'
end
ELSE
    PRINT '<<< FAILED ALTERING PROCEDURE jusp_op_solicitudes>>>'
go
