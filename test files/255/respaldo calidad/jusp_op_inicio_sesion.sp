...
/*  02/02/2021         Henderson Villegas Se incluye @o_login operacion Q*/
/******************************************************************/

CREATE procedure [dbo].[jusp_op_inicio_sesion](@i_operacion char(1),
...
-- Actualizar estado de contraseña vencida
	if @i_operacion = 'H'
	begin
		update webuser_jur..ju_autorizados
