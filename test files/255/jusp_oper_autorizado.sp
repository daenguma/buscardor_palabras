...
/* 28-02-2012  	Ivan Perez        Cambio operacion 'D'    	*/
/*                                envio parametro @i_gasa 	*/
/*                                sp_login_cliente_bv     	*/
/*                                                        	*/
/* 30-03-2012  	Ivan Perez        Cambio operacion 'C'    	*/
/*                                envio parametro @i_ssl  	*/
/*                                sp_clientes_bv          	*/
/* 23-04-2012	Aurymar Romero    Cambio oper='I'         	*/
/* 07-04-2014 	Jose Ñañez        Cambio oper='I' elimina 	*/
/*                                Perfil anterior         	*/
/* 20-08-2014	Daniel Betancourt GrupoEconomico            */
...
ALTER Procedure [dbo].[jusp_oper_autorizado](
  @s_ssn               int          = null,
  @s_user              varchar(20),
  @s_term              varchar(30),
  @s_date              datetime,
...
IF OBJECT_ID('jusp_oper_autorizado') IS NOT NULL
BEGIN
    PRINT '<<< ALTER PROCEDURE jusp_oper_autorizado >>>'
END
ELSE
    PRINT '<<< FAILED ALTERING PROCEDURE jusp_oper_autorizado >>>'
